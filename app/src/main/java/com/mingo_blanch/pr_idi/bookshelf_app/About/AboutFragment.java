package com.mingo_blanch.pr_idi.bookshelf_app.About;
...
public class AboutFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ((TextView) view.findViewById(R.id.about_description)).setText(Html.fromHtml(getString(R.string.app_description)));

        // Handle screen rotation
        ScrollView rl = (ScrollView) view.findViewById(R.id.about_scroll_view);
